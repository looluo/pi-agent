...
- On Windows, the native title bar is hidden. The app top bar is marked as a Tauri drag region during the build step, and custom minimize, maximize, and close buttons are injected into the top-right corner.
